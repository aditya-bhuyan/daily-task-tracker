...
- **Recurring tasks** — set a task to repeat daily, weekly, monthly, yearly, hourly, or by custom cron expression
...
- **Calendar view** — monthly grid with task density dots; click any day to see its tasks
...
| [04 — Task Management](./04-task-management.md) | Create, edit, complete, recurring tasks |
| [05 — Notifications & Tray](./05-notifications-tray.md) | Notifications, snooze, system tray |
| [06 — Data & Backup](./06-data-backup.md) | Storage location, backup, reset |
